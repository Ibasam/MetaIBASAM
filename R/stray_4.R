...
# barplot(colSums(mstray),names.arg=paste0(1:4),main="Cumulative proportion of strayers (%)")
...
#barplot(area,names.arg=paste0(1:4),main="Area of production")

#plot(x,y,pch=NA);text(x,y,labels = 1:4)
